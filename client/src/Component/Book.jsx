...
const BookNow = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://127.0.0.1:3001/shoppingcart", {
        headers: {
          Authorization: ` ${Token}`,
  ...
  const handleDelete = (bookingId, index) => {
    axios
      .put(`http://localhost:3001/product/delete/${bookingId}`, bookingData, {
        headers: {
          Authorization: ` ${Token}`,
          // Add other headers if needed
        },
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://127.0.0.1:3001/booking", formData, {
        headers: {
          Authorization: ` ${Token}`,
          // Add other headers if needed
        },
  ...
  return (
    <div>
      ...
      <p class="text-4xl font-semibold tracking-widest text-g uppercase text-center">
        Booking <span className="text-blue-500">Information</span>
      </p>
      <br></br>
      <br></br>
      ...
      <p class="text-4xl font-semibold tracking-widest text-g uppercase text-center">
      Pay  <span className="text-blue-500">now</span>
      </p>
      <br></br>
      <br></br>
      <br></br>
